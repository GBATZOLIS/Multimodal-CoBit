...
Gaussian corruption of the bitstream, the probability-space objective of \eqref{eq:loss}, an
...
denoiser evaluations per step, whereas unguided joint generation uses one. Evaluation is
domain-specific: exact string matching and a calibrated digit classifier for MNIST-Sum; Whisper,
UTMOS and speaker similarity for speech; and ProteinMPNN redesign followed by ESMFold refolding for
proteins.
