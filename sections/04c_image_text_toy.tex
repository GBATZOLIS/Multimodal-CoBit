...
this flat sequence and its 1-D position, but no pixel grid, 2-D attention structure, image encoder,
text encoder, modality-specific embedding or modality-specific head. A single 63.3M-parameter model trained for 500K steps performs all three
