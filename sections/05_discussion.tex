...
layout, the same continuous denoising formulation produces capable models across image--text,
speech--text and protein sequence--structure tasks. Within each checkpoint, joint and conditional
