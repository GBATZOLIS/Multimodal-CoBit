...
structure it captures residue-aligned, physically coupled channels: 70\% of its generated pairs
agree at the fold level (scTM~$\geq$~0.9), against 32.5\% at scRMSD~$\leq$~2\,\AA. Within each
setting, one checkpoint serves joint and conditional generation.

These results come from denoisers of 63M to 633M parameters trained from scratch. They motivate
testing how far pretraining, larger models, broader data and better continuous-modality tokenizers
can advance performance within the same protocol.
